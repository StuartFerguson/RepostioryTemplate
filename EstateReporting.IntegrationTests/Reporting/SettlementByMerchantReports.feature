@base @shared
Feature: SettlementByMerchantReports
...
Scenario: Settlement By Merchant
	When I get the Estate Settlement By Merchant Report for Estate 'Test Estate1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| Merchant        | NumberOfFeesSettled | ValueOfFeesSettled |
	| Test Merchant 1 | 3                   | 0.88               |
	| Test Merchant 2 | 3                   | 0.93               |
