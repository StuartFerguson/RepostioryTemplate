@base @shared
Feature: SettlementByMonthReports
...
Background: 
	...
	| 2022-01-06 | 1                 | Sale            | Test Merchant 2 | 123456781        | Test Estate1 | Safaricom    | 101.00            | 123456789             |                      | Safaricom Contract  | Variable Topup |
	| 2022-01-06 | 2                 | Sale            | Test Merchant 2 | 123456781        | Test Estate1 | Safaricom    | 55.00              | 123456789             |                      | Safaricom Contract  | Variable Topup |
	| 2022-01-06 | 3                 | Sale            | Test Merchant 2 | 123456781        | Test Estate1 | Safaricom    | 27.00             | 123456789             |                      | Safaricom Contract  | Variable Topup |
...
Scenario: Settlement By Month
	When I get the Estate Settlement By Month Report for Estate 'Test Estate1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementMonth | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 1               | 2022           | 3                   | 0.88               |
	| 2               | 2022           | 3                   | 0.93               |

Scenario: Settlement By Month for Merchant
	When I get the Estate Settlement By Month Report for Estate 'Test Estate1' and Merchant 'Test Merchant 1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementMonth | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 1               | 2022           | 3                   | 0.88               |
When I get the Estate Settlement By Month Report for Estate 'Test Estate1' and Merchant 'Test Merchant 2' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementMonth | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 2               | 2022           | 3                   | 0.93               |
