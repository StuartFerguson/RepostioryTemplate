@base @shared
Feature: SettlementByWeekReports
...
Scenario: Settlement By Week
	When I get the Estate Settlement By Week Report for Estate 'Test Estate1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementWeek | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 3               | 2022           | 3                   | 0.88               |
	| 7               | 2022           | 3                   | 0.93               |

Scenario: Settlement By Week for Merchant
	When I get the Estate Settlement By Week Report for Estate 'Test Estate1' for Merchant 'Test Merchant 1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementWeek | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 3               | 2022           | 3                   | 0.88               |
	When I get the Estate Settlement By Week Report for Estate 'Test Estate1' for Merchant 'Test Merchant 2' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementWeek | SettlementYear | NumberOfFeesSettled | ValueOfFeesSettled |
	| 7               | 2022           | 3                   | 0.93               |
