@base @shared
Feature: TransactionsByMerchantReports
...
Scenario: Sales Transactions By Merchant - Transactions All For Same Merchant
...
Scenario: Sales Transactions By Merchant - Transactions For Mutiple Merchants
	...
	When I get the Estate Transactions By Merchant Report for Estate 'Test Estate 1' with the Start Date 'LastMonth' and the End Date 'Today' the following data is returned
	| MerchantName  | NumberOfTransactions | ValueOfTransactions |
	| Test Merchant 1 | 6                    | 250.00            |
	| Test Merchant 2 | 3                    | 275.00            |

	When I get the Estate Transactions By Merchant Report for Estate 'Test Estate 2' with the Start Date 'LastMonth' and the End Date 'Today' the following data is returned
	| MerchantName  | NumberOfTransactions | ValueOfTransactions |
	| Test Merchant 3 | 4                    | 500.00            |