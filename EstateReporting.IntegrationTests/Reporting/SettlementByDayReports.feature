@base @shared
Feature: SettlementByDayReports
...
Scenario: Settlement By Day
	When I get the Estate Settlement By Date Report for Estate 'Test Estate1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementDate | NumberOfFeesSettled | ValueOfFeesSettled |
	| 2022-01-13     | 3                   | 0.88               |
	| 2022-02-06     | 3                   | 0.93               |

Scenario: Settlement By Day for Merchant
	When I get the Estate Settlement By Date Report for Estate 'Test Estate1' and Merchant 'Test Merchant 1' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementDate | NumberOfFeesSettled | ValueOfFeesSettled |
	| 2022-01-13     | 3                   | 0.88               |
	When I get the Estate Settlement By Date Report for Estate 'Test Estate1' and Merchant 'Test Merchant 2' with the Start Date '2022-01-13' and the End Date '2022-02-06' the following data is returned
	| SettlementDate | NumberOfFeesSettled | ValueOfFeesSettled |
